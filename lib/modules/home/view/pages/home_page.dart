...
import 'package:portfolio/modules/home/sections/cv/view/pages/cv_secation.dart';
import 'package:portfolio/modules/home/view/widgets/home_drawer.dart';
import '../../../../core/constant/size/app_size.dart';
import '../../sections/contact_me/view/pages/contact_me_section.dart';
import '../../sections/contact_me/view/pages/social_media_section.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: AppSize.isMobileScreen(context: context)
            ? const HomeDrawer()
            : null,
        body: SizedBox(
